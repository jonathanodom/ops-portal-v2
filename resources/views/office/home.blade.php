<x-layouts.office title="Operations Dashboard" width="workspace">
    @php
    ...
    <x-office.page-header
        ...
        :description="$activeOrganization->name.' · Today’s schedule, work queues, billing, and operational exceptions.'"
