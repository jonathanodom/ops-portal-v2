...
<section
    ...
    data-search-url="{{ $customerSearchUrl ?? route('office.service-tickets.customer-options') }}"
...
>
    <div class="grid gap-5 md:grid-cols-2">
        ...
        <div>
            <label class="form-label" for="contact_id">{{ $contactFieldLabel ?? 'Designated contact' }} <span class="font-normal text-slate-500">(optional)</span></label>
