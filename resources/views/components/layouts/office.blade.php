...
@php
    ...
    $officeNavigation = array_values(array_filter([
        ...
        $activeMembership->hasCapability('opportunities.view') ? ['key' => 'leads', 'label' => 'Leads ('.($unresolvedLeadCount ?? 0).')', 'mobile_label' => 'Leads ('.($unresolvedLeadCount ?? 0).')', 'icon' => 'opportunities', 'href' => route('office.leads.index'), 'active' => request()->routeIs('office.leads.*')] : null,
