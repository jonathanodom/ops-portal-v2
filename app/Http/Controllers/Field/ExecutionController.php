...
class ExecutionController extends Controller
{
    ...
    public function save(Request $r, string $visit, FieldExecution $flow): RedirectResponse|Response|JsonResponse
    {
        ...
        $d = $r->validate(['content_version' => 'required|integer', 'outcome' => ['nullable', Rule::in(['resolved', 'needs_return_trip', 'customer_unavailable', 'on_hold'])], 'diagnosis' => 'nullable|string|max:10000', 'work_performed' => 'nullable|string|max:10000', 'result_summary' => 'nullable|string|max:10000', 'exceptions' => 'nullable|string|max:10000', 'recommendations' => 'nullable|string|max:10000', 'return_reason' => 'nullable|string|max:5000', 'unfinished_work' => 'nullable|string|max:5000', 'needed_equipment' => 'nullable|string|max:5000', 'hold_reason' => 'nullable|string|max:5000', 'unavailable_category' => ['nullable', Rule::in(array_keys(config('field_execution.unavailable_reasons')))], 'unavailable_detail' => 'nullable|string|max:5000', 'representative_name' => 'nullable|string|max:255', 'representative_role' => 'nullable|string|max:120', 'ack_unavailable_category' => ['nullable', Rule::in(array_keys(config('field_execution.ack_fallbacks')))], 'ack_unavailable_detail' => 'nullable|string|max:5000', 'no_photo_category' => ['nullable', Rule::in(array_keys(config('field_execution.no_photo_reasons')))], 'no_photo_detail' => 'nullable|string|max:5000']);
