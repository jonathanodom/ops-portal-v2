...
final class ProjectWorkspaceQuery
{
    ...
    {
        $project->load(['owner:id,name', 'workstreams.owner:id,name', 'workstreams.tasks.assignee:id,name', 'tasks.workstream:id,name', 'tasks.assignee:id,name', 'milestones', 'notes.author:id,name', 'storedAttachments.uploader:id,name', 'commercialScopes.acceptance.publication', 'commercialScopes.acceptance.selections', 'commercialScopes.materialItems', 'commercialScopes.laborItems', 'commercialScopes.billingMilestones.acceptedMilestone.invoice', 'changeOrders.revisions.publication.acceptance', 'allowanceResolutions']);
