...
#[Fillable(['organization_id', 'commercial_revision_id', 'location_id', 'system_id', 'phase_id', 'catalog_category_id', 'line_type', 'catalog_product_id', 'catalog_service_id', 'catalog_service_variant_id', 'catalog_package_id', 'package_pricing_mode', 'source_code', 'description', 'customer_description', 'unit_code', 'unit_name', 'quantity_millis', 'catalog_unit_sell_cents', 'effective_unit_sell_cents', 'sell_price_overridden', 'cost_basis_cents', 'cost_basis_quantity_millis', 'cost_resolved', 'cost_source_type', 'cost_source_id', 'cost_source_name', 'discount_type', 'discount_value', 'optional', 'included', 'taxable', 'sort_order', 'gross_sell_cents', 'line_discount_cents', 'quote_discount_cents', 'tax_cents', 'total_cents', 'resolved_cost_cents'])]
