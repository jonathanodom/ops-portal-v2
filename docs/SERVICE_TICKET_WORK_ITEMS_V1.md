...
- Local benchmark, 10 warm runs: Home 14.3 ms/31 queries, Today 8.9/9, Dispatch 19.5/15, Projects 13.0/16, Customer detail 11.1/21, Project detail 20.0/25, Ticket detail remained under 39 queries, Review detail 14.6/27, and authorized media first byte 0.1 ms. The Ticket-detail ceiling moves from 33 to 39 based on the measured six-query, fixed-cost eager-load set for Work Items, discovery/touch Visit provenance, return lineage, and follow-up Ticket links; it does not grow per Work Item or Visit.
