...
return new class extends Migration
{
    ...
    {
        if (! Schema::hasTable('organization_commercial_settings')) {
        ...
        if (! Schema::hasTable('opportunity_tasks')) {
        ...
        if (! Schema::hasTable('opportunity_activities')) {
        ...
        if (! Schema::hasTable('commercial_user_preferences')) {
