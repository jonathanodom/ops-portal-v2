...
return new class extends Migration
{
    public function up(): void
    {
        Schema::table('organization_billing_settings', function (Blueprint $table): void {
            $table->foreignId('default_labor_catalog_service_id')->nullable()->after('default_tax_rate_basis_points')->constrained('catalog_services')->restrictOnDelete();
            ...
            $table->foreignId('trip_charge_catalog_service_id')->nullable()->after('minimum_billable_minutes')->constrained('catalog_services')->restrictOnDelete();
    ...
    {
        Schema::table('organization_billing_settings', function (Blueprint $table): void {
            $table->dropConstrainedForeignId('trip_charge_catalog_service_id');
            $table->dropConstrainedForeignId('default_labor_catalog_service_id');
            $table->dropColumn([
